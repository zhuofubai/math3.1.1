 ...
 * @since 2.0
 */
public class BlockRealMatrix_bug2 extends AbstractRealMatrix implements Serializable {
	Foo _foo=new Foo();
    /** Block size. */
     ...
     * positive.
     */
    public BlockRealMatrix_bug2(final int rows, final int columns)
     ...
     * @throws NotStrictlyPositiveException if row or column dimension is not
     * positive.
     * @see #BlockRealMatrix_bug2(int, int, double[][], boolean)
     */
    public BlockRealMatrix_bug2(final double[][] rawData)
     ...
     * @see #BlockRealMatrix_bug2(double[][])
     */
    public BlockRealMatrix_bug2(final int rows, final int columns,
     ...
     * is the layout used in {@link BlockRealMatrix_bug2} instances, where the matrix
     ...
     * #BlockRealMatrix_bug2(int, int, double[][], boolean)} constructor.
     * </p>
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug2 createMatrix(final int rowDimension,
                                        final int columnDimension)
        throws NotStrictlyPositiveException {
        return new BlockRealMatrix_bug2(rowDimension, columnDimension);
    }

    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug2 copy() {
        // create an empty matrix
        BlockRealMatrix_bug2 copied = new BlockRealMatrix_bug2(rows, columns);
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug2 add(final RealMatrix m)
        throws MatrixDimensionMismatchException {
        try {
            return add((BlockRealMatrix_bug2) m);
        } catch (ClassCastException cce) {
            // safety check
            MatrixUtils.checkAdditionCompatible(this, m);

            final BlockRealMatrix_bug2 out = new BlockRealMatrix_bug2(rows, columns);
     ...
     * size as this matrix.
     */
    public BlockRealMatrix_bug2 add(final BlockRealMatrix_bug2 m)
        throws MatrixDimensionMismatchException {
        // safety check
        MatrixUtils.checkAdditionCompatible(this, m);
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug2 subtract(final RealMatrix m)
        throws MatrixDimensionMismatchException {
        try {
            return subtract((BlockRealMatrix_bug2) m);
        } catch (ClassCastException cce) {
            // safety check
     ...
     */
    public BlockRealMatrix_bug2 subtract(final BlockRealMatrix_bug2 m)
        throws MatrixDimensionMismatchException {
        // safety check
        MatrixUtils.checkSubtractionCompatible(this, m);
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug2 scalarAdd(final double d) {
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug2 multiply(final RealMatrix m)
        throws DimensionMismatchException {
        try {
            return multiply((BlockRealMatrix_bug2) m);
        } catch (ClassCastException cce) {
            // safety check
            MatrixUtils.checkMultiplicationCompatible(this, m);

            final BlockRealMatrix_bug2 out = new BlockRealMatrix_bug2(rows, m.getColumnDimension());
     ...
     */
    public BlockRealMatrix_bug2 multiply(BlockRealMatrix_bug2 m)
        throws DimensionMismatchException {
        // safety check
        MatrixUtils.checkMultiplicationCompatible(this, m);

        final BlockRealMatrix_bug2 out = new BlockRealMatrix_bug2(rows, m.columns);
                ...
                for (int kBlock = 0; kBlock < blockColumns; ++kBlock) {
                    ...
                    for (int p = pStart; p < pEnd; ++p) {
                        ...
                        for (int nStart = 0; nStart < jWidth; ++nStart) {
                            ...
                            outBlock[k] =outBlock[k]+ sum;//buggy1+_foo.createsmallnumber();
                            ++k;
                        }
                    }
                }
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug2 getSubMatrix(final int startRow, final int endRow,
        ...
        final BlockRealMatrix_bug2 out =
            new BlockRealMatrix_bug2(temp1,temp2);
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug2 getRowMatrix(final int row)
        throws OutOfRangeException {
        MatrixUtils.checkRowIndex(this, row);
        final BlockRealMatrix_bug2 out = new BlockRealMatrix_bug2(1, columns);
    ...
    public void setRowMatrix(final int row, final RealMatrix matrix)
        ...
        try {
            setRowMatrix(row, (BlockRealMatrix_bug2) matrix);
        } catch (ClassCastException cce) {
     ...
     */
    public void setRowMatrix(final int row, final BlockRealMatrix_bug2 matrix)
        throws OutOfRangeException, MatrixDimensionMismatchException {
        MatrixUtils.checkRowIndex(this, row);
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug2 getColumnMatrix(final int column)
        throws OutOfRangeException {
        MatrixUtils.checkColumnIndex(this, column);
        final BlockRealMatrix_bug2 out = new BlockRealMatrix_bug2(rows, 1);
    ...
    public void setColumnMatrix(final int column, final RealMatrix matrix)
        throws OutOfRangeException, MatrixDimensionMismatchException {
        try {
            setColumnMatrix(column, (BlockRealMatrix_bug2) matrix);
        } catch (ClassCastException cce) {
     ...
     */
    void setColumnMatrix(final int column, final BlockRealMatrix_bug2 matrix)
        throws OutOfRangeException, MatrixDimensionMismatchException {
        MatrixUtils.checkColumnIndex(this, column);
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug2 transpose() {
        final int nRows = getRowDimension();
        final int nCols = getColumnDimension();
        final BlockRealMatrix_bug2 out = new BlockRealMatrix_bug2(nCols, nRows);
        ...
        for (int jBlock = 0; jBlock < blockColumns; ++jBlock) {
            ...
            for (int iBlock = 0; iBlock < blockRows; ++iBlock) {
                ...
                for (int q = qStart; q < qEnd; ++q) {
                    ...
                    int p = pStart;
                    while (p < pEnd - 3) {
                        sum =sum*(1+_foo.createSmallNumber())+ block[k]  * v[p]  +  block[k + jWidth]  * v[p + 1] + block[k + jWidth2] * v[p + 2] +  block[k + jWidth3] * v[p + 3];//buggy2
                        k = k+jWidth4;
                        p = p+4;
                    }
                    while (p < pEnd) {
