 ...
 * @since 2.0
 */
public class BlockRealMatrix_bug5 extends AbstractRealMatrix implements Serializable {
	Foo _foo=new Foo();
    /** Block size. */
     ...
     * positive.
     */
    public BlockRealMatrix_bug5(final int rows, final int columns)
     ...
     * @throws NotStrictlyPositiveException if row or column dimension is not
     * positive.
     * @see #BlockRealMatrix_bug5(int, int, double[][], boolean)
     */
    public BlockRealMatrix_bug5(final double[][] rawData)
     ...
     * @see #BlockRealMatrix_bug5(double[][])
     */
    public BlockRealMatrix_bug5(final int rows, final int columns,
     ...
     * is the layout used in {@link BlockRealMatrix_bug5} instances, where the matrix
     ...
     * #BlockRealMatrix_bug5(int, int, double[][], boolean)} constructor.
     * </p>
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug5 createMatrix(final int rowDimension,
                                        final int columnDimension)
        throws NotStrictlyPositiveException {
        return new BlockRealMatrix_bug5(rowDimension, columnDimension);
    }

    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug5 copy() {
        // create an empty matrix
        BlockRealMatrix_bug5 copied = new BlockRealMatrix_bug5(rows, columns);
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug5 add(final RealMatrix m)
        throws MatrixDimensionMismatchException {
        try {
            return add((BlockRealMatrix_bug5) m);
        } catch (ClassCastException cce) {
            // safety check
            MatrixUtils.checkAdditionCompatible(this, m);

            final BlockRealMatrix_bug5 out = new BlockRealMatrix_bug5(rows, columns);
     ...
     * size as this matrix.
     */
    public BlockRealMatrix_bug5 add(final BlockRealMatrix_bug5 m)
        throws MatrixDimensionMismatchException {
        // safety check
        MatrixUtils.checkAdditionCompatible(this, m);
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug5 subtract(final RealMatrix m)
        throws MatrixDimensionMismatchException {
        try {
            return subtract((BlockRealMatrix_bug5) m);
        } catch (ClassCastException cce) {
            // safety check
     ...
     */
    public BlockRealMatrix_bug5 subtract(final BlockRealMatrix_bug5 m)
        throws MatrixDimensionMismatchException {
        // safety check
        MatrixUtils.checkSubtractionCompatible(this, m);
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug5 scalarAdd(final double d) {
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug5 multiply(final RealMatrix m)
        throws DimensionMismatchException {
        try {
            return multiply((BlockRealMatrix_bug5) m);
        } catch (ClassCastException cce) {
            // safety check
            MatrixUtils.checkMultiplicationCompatible(this, m);

            final BlockRealMatrix_bug5 out = new BlockRealMatrix_bug5(rows, m.getColumnDimension());
     ...
     */
    public BlockRealMatrix_bug5 multiply(BlockRealMatrix_bug5 m)
        throws DimensionMismatchException {
        // safety check
        MatrixUtils.checkMultiplicationCompatible(this, m);

        final BlockRealMatrix_bug5 out = new BlockRealMatrix_bug5(rows, m.columns);
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug5 getSubMatrix(final int startRow, final int endRow,
        ...
        final BlockRealMatrix_bug5 out =
            new BlockRealMatrix_bug5(temp1,temp2);
    ...
    private void copyBlockPart(final double[] srcBlock, final int srcWidth,
        ...
        int srcPos = srcStartRow + srcWidth + srcStartColumn;//buggy5 srcStartRow * srcWidth to srcStartRow + srcWidth
        ...
        for (int iBlock = blockStartRow; iBlock < blockEndRow; ++iBlock) {
            ...
            for (int jBlock = blockStartColumn; jBlock < blockEndColumn; ++jBlock) {
                ...
                for (int i = iStart; i < iEnd; ++i) {
                	int temp=(i - firstRow) * jWidth + (jStart - firstColumn);
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug5 getRowMatrix(final int row)
        throws OutOfRangeException {
        MatrixUtils.checkRowIndex(this, row);
        final BlockRealMatrix_bug5 out = new BlockRealMatrix_bug5(1, columns);
    ...
    public void setRowMatrix(final int row, final RealMatrix matrix)
        ...
        try {
            setRowMatrix(row, (BlockRealMatrix_bug5) matrix);
        } catch (ClassCastException cce) {
     ...
     */
    public void setRowMatrix(final int row, final BlockRealMatrix_bug5 matrix)
        throws OutOfRangeException, MatrixDimensionMismatchException {
        MatrixUtils.checkRowIndex(this, row);
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug5 getColumnMatrix(final int column)
        throws OutOfRangeException {
        MatrixUtils.checkColumnIndex(this, column);
        final BlockRealMatrix_bug5 out = new BlockRealMatrix_bug5(rows, 1);
    ...
    public void setColumnMatrix(final int column, final RealMatrix matrix)
        throws OutOfRangeException, MatrixDimensionMismatchException {
        try {
            setColumnMatrix(column, (BlockRealMatrix_bug5) matrix);
        } catch (ClassCastException cce) {
     ...
     */
    void setColumnMatrix(final int column, final BlockRealMatrix_bug5 matrix)
        throws OutOfRangeException, MatrixDimensionMismatchException {
        MatrixUtils.checkColumnIndex(this, column);
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug5 transpose() {
        final int nRows = getRowDimension();
        final int nCols = getColumnDimension();
        final BlockRealMatrix_bug5 out = new BlockRealMatrix_bug5(nCols, nRows);
            ...
            for (int jBlock = 0; jBlock < blockColumns; ++jBlock) {
                ...
                for (int p = pStart; p < pEnd; ++p) {
                    ...
                    while (q < qEnd - 3) {
                        ...
                        sum =sum+ block[k] * v[q]  +  block[k + 1] * v[q + 1] + block[k + 2] * v[q + 2] +  block[k + 3] * v[q + 3];//buggy4
                        k =k+ 4;
                        q =q+ 4;
                    }
                    while (q < qEnd) {
        ...
        for (int jBlock = 0; jBlock < blockColumns; ++jBlock) {
            ...
            for (int iBlock = 0; iBlock < blockRows; ++iBlock) {
                ...
                for (int q = qStart; q < qEnd; ++q) {
                    ...
                    int p = pStart;
                    while (p < pEnd - 3) {
                        sum =sum+ block[k]  * v[p]  +  block[k + jWidth]  * v[p + 1] + block[k + jWidth2] * v[p + 2] +  block[k + jWidth3] * v[p + 3];//buggy2 sum*(1+_foo.createSmallNumber())
                        k = k+jWidth4;
                        p = p+4;
                    }
                    while (p < pEnd) {
