 ...
 * @since 2.0
 */
public class BlockRealMatrix_bug3 extends AbstractRealMatrix implements Serializable {
	Foo _foo=new Foo();
    /** Block size. */
     ...
     * positive.
     */
    public BlockRealMatrix_bug3(final int rows, final int columns)
     ...
     * @throws NotStrictlyPositiveException if row or column dimension is not
     * positive.
     * @see #BlockRealMatrix_bug3(int, int, double[][], boolean)
     */
    public BlockRealMatrix_bug3(final double[][] rawData)
     ...
     * @see #BlockRealMatrix_bug3(double[][])
     */
    public BlockRealMatrix_bug3(final int rows, final int columns,
     ...
     * is the layout used in {@link BlockRealMatrix_bug3} instances, where the matrix
     ...
     * #BlockRealMatrix_bug3(int, int, double[][], boolean)} constructor.
     * </p>
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug3 createMatrix(final int rowDimension,
                                        final int columnDimension)
        throws NotStrictlyPositiveException {
        return new BlockRealMatrix_bug3(rowDimension, columnDimension);
    }

    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug3 copy() {
        // create an empty matrix
        BlockRealMatrix_bug3 copied = new BlockRealMatrix_bug3(rows, columns);
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug3 add(final RealMatrix m)
        throws MatrixDimensionMismatchException {
        try {
            return add((BlockRealMatrix_bug3) m);
        } catch (ClassCastException cce) {
            // safety check
            MatrixUtils.checkAdditionCompatible(this, m);

            final BlockRealMatrix_bug3 out = new BlockRealMatrix_bug3(rows, columns);
     ...
     * size as this matrix.
     */
    public BlockRealMatrix_bug3 add(final BlockRealMatrix_bug3 m)
        throws MatrixDimensionMismatchException {
        // safety check
        MatrixUtils.checkAdditionCompatible(this, m);
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug3 subtract(final RealMatrix m)
        throws MatrixDimensionMismatchException {
        try {
            return subtract((BlockRealMatrix_bug3) m);
        } catch (ClassCastException cce) {
            // safety check
     ...
     */
    public BlockRealMatrix_bug3 subtract(final BlockRealMatrix_bug3 m)
        throws MatrixDimensionMismatchException {
        // safety check
        MatrixUtils.checkSubtractionCompatible(this, m);
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug3 scalarAdd(final double d) {
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug3 multiply(final RealMatrix m)
        throws DimensionMismatchException {
        try {
            return multiply((BlockRealMatrix_bug3) m);
        } catch (ClassCastException cce) {
            // safety check
            MatrixUtils.checkMultiplicationCompatible(this, m);

            final BlockRealMatrix_bug3 out = new BlockRealMatrix_bug3(rows, m.getColumnDimension());
     ...
     */
    public BlockRealMatrix_bug3 multiply(BlockRealMatrix_bug3 m)
        throws DimensionMismatchException {
        // safety check
        MatrixUtils.checkMultiplicationCompatible(this, m);

        final BlockRealMatrix_bug3 out = new BlockRealMatrix_bug3(rows, m.columns);
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug3 getSubMatrix(final int startRow, final int endRow,
        ...
        final BlockRealMatrix_bug3 out =
            new BlockRealMatrix_bug3(temp1,temp2);
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug3 getRowMatrix(final int row)
        throws OutOfRangeException {
        MatrixUtils.checkRowIndex(this, row);
        final BlockRealMatrix_bug3 out = new BlockRealMatrix_bug3(1, columns);
    ...
    public void setRowMatrix(final int row, final RealMatrix matrix)
        ...
        try {
            setRowMatrix(row, (BlockRealMatrix_bug3) matrix);
        } catch (ClassCastException cce) {
     ...
     */
    public void setRowMatrix(final int row, final BlockRealMatrix_bug3 matrix)
        throws OutOfRangeException, MatrixDimensionMismatchException {
        MatrixUtils.checkRowIndex(this, row);
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug3 getColumnMatrix(final int column)
        throws OutOfRangeException {
        MatrixUtils.checkColumnIndex(this, column);
        final BlockRealMatrix_bug3 out = new BlockRealMatrix_bug3(rows, 1);
    ...
    public void setColumnMatrix(final int column, final RealMatrix matrix)
        throws OutOfRangeException, MatrixDimensionMismatchException {
        try {
            setColumnMatrix(column, (BlockRealMatrix_bug3) matrix);
        } catch (ClassCastException cce) {
     ...
     */
    void setColumnMatrix(final int column, final BlockRealMatrix_bug3 matrix)
        throws OutOfRangeException, MatrixDimensionMismatchException {
        MatrixUtils.checkColumnIndex(this, column);
    ...
    /** {@inheritDoc} */
    @Override
    public BlockRealMatrix_bug3 transpose() {
        final int nRows = getRowDimension();
        final int nCols = getColumnDimension();
        final BlockRealMatrix_bug3 out = new BlockRealMatrix_bug3(nCols, nRows);
